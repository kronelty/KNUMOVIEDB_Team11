	...
	%>  	<div class="nav-items" Onclick="location.href='info.jsp?id=<%=id%>'" style="cursor:pointer;">내 정보</div>
   		...
   		<div class="main">
   			...
   			<div class="select-items">
   				<div class="select-items-title">전체목록 보기</div>
   				<div class="select-items-detail">영상물의 전체 목록을 불러옵니다.</div>
   				<button class="select-items-btton" style="cursor:pointer;" Onclick="location.href='MovieView.jsp?id=<%=id%>&isAdmin=<%=isAdmin%>'">불러오기</button>
   			</div>
   			<div class="select-items">
   				<div class="select-items-title">제목으로 검색</div>
   				<div class="select-items-detail">제목으로 등록된 영상물을 검색합니다.</div>
   				<button class="select-items-btton" style="cursor:pointer;" Onclick="location.href='MovieSearch.jsp?id=<%=id%>&isAdmin=<%=isAdmin%>'">검색하기</button>
   			</div>
   			<div class="select-items">
   				<div class="select-items-title">특정조건 검색</div>
   				<div class="select-items-detail">특정 조건으로 영상물을 검색합니다. 장르별, 나라별 검색이 가능합니다.</div>
   				<button class="select-items-btton" style="cursor:pointer;" Onclick="location.href='MovieSearchSpecial.jsp?id=<%=id%>&isAdmin=<%=isAdmin%>'">검색하기</button>
   			</div>
   			<%
         ...
         <div class="select-items">
            	...
            	<div class="select-items-detail">장르를 고르시면 영화를 추천해드립니다.</div>
            ...
            <button class="select-items-btton" type="submit">추천영화</button>
         	</form>
         	</div>
   			</div>	
   		</div>
